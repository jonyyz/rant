...
void title(register char *buf);
void nounphr (register char *buf);
void sentence (register char *buf);
void attribute (register char *buf);
void be (register char *buf);
void predicate (register char *buf);
void put_clause (register char *buf);
void output(register char *buf);
...
void put_clause (register char *buf)        /* a clause to preceed the sentence */
{
